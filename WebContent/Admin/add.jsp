...
<body>
<form action="${pageContext.request.contextPath}/admin/addAdmin.action" method="post" class="definewidth m20">
<table class="table table-bordered table-hover definewidth m10">
    ...
    <tr>
        ...
        <td>
        	<input type="radio" name="admin_action_id" value="1" checked/> 超级管理员
           <input type="radio" name="admin_action_id" value="2"/> 1级管理员
