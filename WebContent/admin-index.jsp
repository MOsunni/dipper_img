...
<head>
  ...
  <script type="text/javascript" src="assets/js/amazeui.ie8polyfill.min.js"></script>
      ...
      <ul class="am-list admin-sidebar-list">
        ...
        <li class="admin-parent">
          ...
          <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav">
            <li><a href="admin-user.html" class="am-cf"><span class="am-icon-check"></span> 图片展示 <span class="am-icon-star am-fr am-margin-right admin-icon-yellow"></span></a></li>
